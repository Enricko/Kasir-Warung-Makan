import 'package:kasir_warung_makan/config/config.dart';
import 'package:kasir_warung_makan/constants/constants.dart';
import 'package:kasir_warung_makan/theme/theme.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  () => Wrap(
                    ...
                    children: [
                      MenuCard(
                        title: 'pecel',
                        price: '12.000',
                        color: ColorCollections.pecel,
                        icon: 'icon-pecel',
                        count: controller.pecel.value.count,
                        addFunction: () => controller.addpecel(),
                        removeFunction: () => controller.removepecel(),
                      ),
                      MenuCard(
                        title: 'Nasi',
                        price: '4000',
      ...
      bottomNavigationBar: Container(
        height: getPropertionateScreenWidht(160),
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
              height: getPropertionateScreenWidht(35),
              child: ElevatedButton(
                onPressed: () {
                  Get.defaultDialog(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: getPropertionateScreenWidht(50),
                      decoration: BoxDecoration(
                        color: color,
                        borderRadius: const BorderRadius.only(
                          topLeft: Radius.circular(20),
